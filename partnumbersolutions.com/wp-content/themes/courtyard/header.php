			...
			<div class="container">
                ...
                <ul id="social-iconos">
                  ...
                  <div class="menu-menu-ppal-container">
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-177"><a href="http://partnumbersolutions.com">Inicio</a></li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-177"><a href="#quienessomos">¿Quienes Somos?</a></li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-178"><a href="#servicios">Servicios</a></li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-179"><a href="#industrias">Industrias</a></li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-180"><a href="#contacto">Contacto</a></li>
                    </ul>
                  </div>
							</div>
						</nav><!-- .pt-menu -->
