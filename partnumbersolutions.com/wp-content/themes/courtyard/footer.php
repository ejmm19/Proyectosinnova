		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			<div class="container">
				<div class="row">
					<div class="site-info">
						<center>
						  <p>Copyright © 2017 Parts Number Solutions All rights reserved. | Designed by <img src="https://res.cloudinary.com/alexapgutierrez-co/image/upload/v1487781950/branding-up-copy_e4dyac.png" width="80px" ></p>
						</center>
					</div><!-- .site-info -->
				</div><!-- .container -->
			</div><!-- .row -->
